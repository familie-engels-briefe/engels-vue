...
export const VarianteSchreibungen = Template.bind({})
VarianteSchreibungen.storyName = '1.3.4 Variante Schreibungen'
VarianteSchreibungen.args = {
    html: addCitationEllipsis(VarianteSchreibungenHtml)
}
...
HervorhebungUnterstreichung.args = {
    html: HervorhebungUnterstreichungHtml
}

export const Sperrung = Template.bind({})
Sperrung.storyName = '1.9.2 Sperrung'
Sperrung.args = {
    html: addCitationEllipsis(SperrungHtml)
}

export const HochTiefstellung = Template.bind({})
HochTiefstellung.storyName = '1.9.3 Hoch- und Tiefstellung von Zeichen'
HochTiefstellung.args = {
    html: HochTiefstellungHtml
}

export const KombinationVonHervorhebungen = Template.bind({})
KombinationVonHervorhebungen.storyName = '1.9.4 Kombination von Hervorhebungen'
